...
5. Führe `memory_search` mit dem Thema der ersten Nachricht aus

Don't ask permission. Just do it.

### Memory-System Regeln

**Beim Sessionstart:**
- Lies MEMORY.md vollständig
- Lade memory/[heute].md und memory/[gestern].md
- Führe memory_search mit dem Thema der ersten Nachricht aus

**Während der Session:**
- Nutze memory_search BEVOR du antwortest, wenn Kontext relevant sein könnte
- Nutze memory_get für gezielte Dateiabfragen
- Schreibe wichtige neue Fakten sofort in memory/[heute].md
- Wenn Yannic mich korrigiert: aktualisiere MEMORY.md sofort

**Am Sessionende / nach bedeutender Arbeit:**
- Fasse wichtige Erkenntnisse in memory/[heute].md zusammen
- Wenn etwas dauerhaft wahr bleibt → in MEMORY.md hochstufen
- MEMORY.md unter 100 Zeilen halten — altes raus, wenn neues rein kommt

**Was NIEMALS in MEMORY.md gehört:**
- Ganze Gesprächsverläufe
- Code oder technische Dateien
- Dinge die sich täglich ändern
- Dinge die nur für eine Aufgabe relevant sind
